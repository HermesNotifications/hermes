...
func TestFilterChannelsForType_AllTemplates(t *testing.T) {
	...
	got := dispatch.FilterChannelsForType([]string{"email", "sms", "inbox"}, nt)
	if len(got) != 3 {
...
func TestFilterChannelsForType_NoEmailTemplate(t *testing.T) {
	...
	got := dispatch.FilterChannelsForType([]string{"email", "inbox"}, nt)
...
func TestFilterChannelsForType_NilType(t *testing.T) {
	got := dispatch.FilterChannelsForType([]string{"email", "inbox"}, nil)
	if len(got) != 2 {
