...
| [0005](0005-transport-security-for-infrastructure-connections.md) | Authenticate and encrypt connections to NATS, Postgres and Redis, with a config surface rather than connection-string archaeology | Accepted (amended 2026-07-31) | 2026-07-29 |
