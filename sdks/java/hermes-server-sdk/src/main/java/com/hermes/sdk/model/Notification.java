...
import com.hermes.sdk.model.NotificationMetadata;
...
public class Notification {
  ...
  public Notification metadata(@javax.annotation.Nullable NotificationMetadata metadata) {
  ...
  public void setMetadata(@javax.annotation.Nullable NotificationMetadata metadata) {
    this.metadata = metadata;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionLabel, actionUrl, archivedAt, body, categoryId, channels, createdAt, deletedAt, deliveredAt, id, idempotencyKey, metadata, organizationId, readAt, sentAt, status, templateId, title, userId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("action_label", "action_url", "archived_at", "body", "category_id", "channels", "created_at", "deleted_at", "delivered_at", "id", "idempotency_key", "metadata", "organization_id", "read_at", "sent_at", "status", "template_id", "title", "user_id"));
