...
public class UpdateTypeInputBody {
  ...
  public UpdateTypeInputBody emailBody(@javax.annotation.Nullable String emailBody) {
  ...
  public UpdateTypeInputBody emailSubject(@javax.annotation.Nullable String emailSubject) {
  ...
  public UpdateTypeInputBody inboxBody(@javax.annotation.Nullable String inboxBody) {
  ...
  public UpdateTypeInputBody inboxTitle(@javax.annotation.Nullable String inboxTitle) {
  ...
  public UpdateTypeInputBody name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateTypeInputBody smsBody(@javax.annotation.Nullable String smsBody) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTypeInputBody updateTypeInputBody = (UpdateTypeInputBody) o;
    return Objects.equals(this.$schema, updateTypeInputBody.$schema) &&
        Objects.equals(this.emailBody, updateTypeInputBody.emailBody) &&
        Objects.equals(this.emailSubject, updateTypeInputBody.emailSubject) &&
        Objects.equals(this.inboxBody, updateTypeInputBody.inboxBody) &&
        Objects.equals(this.inboxTitle, updateTypeInputBody.inboxTitle) &&
        Objects.equals(this.name, updateTypeInputBody.name) &&
        Objects.equals(this.smsBody, updateTypeInputBody.smsBody);
  }

  @Override
  public int hashCode() {
    return Objects.hash($schema, emailBody, emailSubject, inboxBody, inboxTitle, name, smsBody);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("$schema", "email_body", "email_subject", "inbox_body", "inbox_title", "name", "sms_body"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTypeInputBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTypeInputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateTypeInputBody is not found in the empty JSON string", UpdateTypeInputBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTypeInputBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateTypeInputBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateTypeInputBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTypeInputBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTypeInputBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTypeInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTypeInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTypeInputBody>() {
           @Override
           public void write(JsonWriter out, UpdateTypeInputBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTypeInputBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTypeInputBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTypeInputBody
   * @throws IOException if the JSON string is invalid with respect to UpdateTypeInputBody
   */
  public static UpdateTypeInputBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTypeInputBody.class);
  }

  /**
   * Convert an instance of UpdateTypeInputBody to an JSON string
   *
   * @return JSON string
   */
