...
additionalProperties:
  packageGuid: '{71987AF4-F58A-423E-A24D-EBF4D9DE3B98}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            ApiKeyCreatedOutputBody? model = apiResponse.Ok();
        }
...
- appVersion: 1.0.0
- appDescription: Server-to-server API for managing subscription categories, templates, and notifications.
