...
inputSpec: api/admin/openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{AAE3B373-D0FD-4FBB-821E-4ECBCF149824}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IExchangeTokenApiResponse apiResponse = await api.ExchangeTokenAsync("todo");
            TokenOutputBody? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Hermes Admin API
- appVersion: 1.0.0
- appDescription: Server-to-server API for managing notification groups, types, and sending notifications.
