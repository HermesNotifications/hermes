...
namespace Hermes.ServerSdk.Model
{
    ...
    public partial class TokenInputBody : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Requested token lifetime in seconds (min 3600 &#x3D; 1h, max 604800 &#x3D; 7d, default 14400 &#x3D; 4h). The actual expiry includes ±10% random jitter to prevent thundering-herd token refreshes.</value>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.ExpiresInOption.IsSet && this.ExpiresInOption.Value > (long)604800)
            {
            ...
            if (this.ExpiresInOption.IsSet && this.ExpiresInOption.Value < (long)3600)
            {
                yield return new ValidationResult("Invalid value for ExpiresIn, must be a value greater than or equal to 3600.", new [] { "ExpiresIn" });
            }
    ...
    public class TokenInputBodyJsonConverter : JsonConverter<TokenInputBody>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, TokenInputBody tokenInputBody, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (tokenInputBody.ExpiresInOption.IsSet)
                writer.WriteNumber("expires_in", tokenInputBody.ExpiresInOption.Value!.Value);
        }
    }
}
