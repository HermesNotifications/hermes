...
namespace Hermes.ServerSdk.Test.Api
{
    ...
    public sealed class APIKeysApiTests : ApiTestsBase
    {
        ...
        {
            CreateAPIKeyInputBody createAPIKeyInputBody = default!;
            var response = await _instance.CreateApiKeyAsync(createAPIKeyInputBody);
            var model = response.Created();
            Assert.IsType<ApiKeyCreatedOutputBody>(model);
        }
