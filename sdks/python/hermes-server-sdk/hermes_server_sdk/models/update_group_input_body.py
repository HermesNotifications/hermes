...
class UpdateGroupInputBody(BaseModel):
    """
    ...
    default_channels: Optional[List[StrictStr]] = Field(description="Default delivery channels for this group")
    name: StrictStr = Field(description="Human-readable name")
    __properties: ClassVar[List[str]] = ["$schema", "default_channels", "name"]
