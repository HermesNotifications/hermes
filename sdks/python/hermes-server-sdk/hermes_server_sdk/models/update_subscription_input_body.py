...
class UpdateSubscriptionInputBody(BaseModel):
    """
    ...
    sort_order: StrictInt = Field(description="Display order within category")
    __properties: ClassVar[List[str]] = ["$schema", "name", "sort_order"]
