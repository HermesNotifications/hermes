...
class SendOutputBody(BaseModel):
    """
    SendOutputBody
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    notification_id: StrictStr = Field(description="ID of the created notification")
    __properties: ClassVar[List[str]] = ["$schema", "notification_id"]
