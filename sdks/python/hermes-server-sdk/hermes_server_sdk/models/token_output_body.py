...
class TokenOutputBody(BaseModel):
    """
    TokenOutputBody
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    expires_at: StrictStr = Field(description="Token expiration time in RFC3339 format")
    token: StrictStr = Field(description="JWT token for user-facing API access")
    __properties: ClassVar[List[str]] = ["$schema", "expires_at", "token"]
