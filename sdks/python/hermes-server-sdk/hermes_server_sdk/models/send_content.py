...
class SendContent(BaseModel):
    ...
    SendContent
    """ # noqa: E501
    action_label: Optional[StrictStr] = Field(default=None, description="Optional action button label")
    action_url: Optional[StrictStr] = Field(default=None, description="Optional action URL")
    body: StrictStr = Field(description="Notification body")
    title: StrictStr = Field(description="Notification title")
    __properties: ClassVar[List[str]] = ["action_label", "action_url", "body", "title"]
