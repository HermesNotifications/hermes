...
class ApiKeyView(BaseModel):
    ...
    rate_limit_burst: Optional[StrictInt] = Field(default=None, description="Absent means the service default applies.")
    rate_limit_per_second: Optional[StrictInt] = Field(default=None, description="Absent means the service default applies.")
    __properties: ClassVar[List[str]] = ["$schema", "created_at", "id", "name", "permissions", "rate_limit_burst", "rate_limit_per_second"]
