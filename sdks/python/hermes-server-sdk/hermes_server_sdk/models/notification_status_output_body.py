...
class NotificationStatusOutputBody(BaseModel):
    """
    ...
    events: Optional[List[NotificationEvent]] = Field(description="Timeline of notification events")
    notification: Notification = Field(description="The notification record")
    __properties: ClassVar[List[str]] = ["$schema", "events", "notification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [NotificationEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
