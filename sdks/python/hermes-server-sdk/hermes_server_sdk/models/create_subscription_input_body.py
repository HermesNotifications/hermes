...
class CreateSubscriptionInputBody(BaseModel):
    """
    ...
    sort_order: Optional[StrictInt] = Field(default=None, description="Display order within category")
    __properties: ClassVar[List[str]] = ["$schema", "name", "slug", "sort_order"]
