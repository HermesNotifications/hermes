...
class CreateTemplateInputBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["$schema", "default_channels", "email_body", "email_subject", "inbox_body", "inbox_title", "name", "slug", "sms_body", "subscription_id"]
