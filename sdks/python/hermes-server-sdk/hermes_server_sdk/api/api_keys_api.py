...
class APIKeysApi:
    ...
    def create_api_key(
        self,
        create_api_key_input_body: CreateAPIKeyInputBody,
        ...
        :param create_api_key_input_body: (required)
        :type create_api_key_input_body: CreateAPIKeyInputBody
        ...
        _param = self._create_api_key_serialize(
            create_api_key_input_body=create_api_key_input_body,
    ...
    def create_api_key_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiKeyCreatedOutputBody]:
        """Create a new API key
    ...
    def _create_api_key_serialize(
        ...
        if create_api_key_input_body is not None:
            _body_params = create_api_key_input_body
