...
class NotificationsApi:
    ...
    def get_notification(
        self,
        id: Annotated[StrictStr, Field(description="Notification ID")],
    ...
    def get_notification_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NotificationStatusOutputBody]:
        """Get notification status and events
    ...
    def list_notifications(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Max results (default 50)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def send_notification(
        self,
        send_input_body: SendInputBody,
        x_idempotency_key: Annotated[Optional[StrictStr], Field(description="Idempotency key for deduplication")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param send_input_body: (required)
        :type send_input_body: SendInputBody
        :param x_idempotency_key: Idempotency key for deduplication
        ...
        _param = self._send_notification_serialize(
            send_input_body=send_input_body,
    ...
    def _send_notification_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if send_input_body is not None:
            _body_params = send_input_body
