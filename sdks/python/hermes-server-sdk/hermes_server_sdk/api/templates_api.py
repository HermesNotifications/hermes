...
class TemplatesApi:
    ...
    def create_template(
        self,
        create_template_input_body: CreateTemplateInputBody,
        ...
        :param create_template_input_body: (required)
        :type create_template_input_body: CreateTemplateInputBody
        ...
        _param = self._create_template_serialize(
            create_template_input_body=create_template_input_body,
    ...
    def _create_template_serialize(
        ...
        if create_template_input_body is not None:
            _body_params = create_template_input_body
    ...
    def update_template(
        self,
        id: Annotated[StrictStr, Field(description="Template ID")],
        update_template_input_body: UpdateTemplateInputBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Template ID (required)
        :type id: str
        :param update_template_input_body: (required)
        :type update_template_input_body: UpdateTemplateInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_template_serialize(
            id=id,
            update_template_input_body=update_template_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_template_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_template_input_body is not None:
            _body_params = update_template_input_body
