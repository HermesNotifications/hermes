...
class AuthApi:
    ...
    def exchange_token(
        self,
        token_input_body: TokenInputBody,
        ...
        :param token_input_body: (required)
        :type token_input_body: TokenInputBody
        ...
        _param = self._exchange_token_serialize(
            token_input_body=token_input_body,
    ...
    def _exchange_token_serialize(
        ...
        if token_input_body is not None:
            _body_params = token_input_body
